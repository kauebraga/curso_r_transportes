...
# 1) Frota operante por linha pelo GPS para certas linhas por dia (+ gráfico) -----------------

# 1.1) Abrir arquivo de GPS
gps <- fread("gps_rio_amostra.csv")

# 1.2) Selecionar e renomear colunas necessarias
...
# 1.2) Calcular a quantidade de pontos de GPS por dia, veiculo e linha
...
# 1.3) Calcular a quantidade de veiculos por linha
...
# 2.3) Trazer a coluna da quantidade de veiculos da base de GPS p/ a base de frotas
...
# 3) Identificação de linhas que estão rodando com base no GPS --------------------------------
